...
FLAGS="-isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS.sdk -miphoneos-version-min=8.0 -arch arm64 -stdlib=libc++"
...
FLAGS="-isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneSimulator.platform/Developer/SDKs/iPhoneSimulator.sdk -miphoneos-version-min=8.0 -arch x86_64 -stdlib=libc++"
cmake .. -DGDCM_BUILD_DOCBOOK_MANPAGES:BOOL=No -DCMAKE_C_FLAGS:String="$FLAGS" -DCMAKE_CXX_FLAGS:String="$FLAGS"
make -j8
cd ..
